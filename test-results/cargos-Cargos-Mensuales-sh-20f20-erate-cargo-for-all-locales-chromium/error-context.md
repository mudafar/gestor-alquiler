...
- Name: cargos.spec.ts >> Cargos Mensuales >> should generate cargo for all locales
- Location: tests\cargos.spec.ts:8:3
...
Locator: getByRole('cell', { name: 'Local para Cargo' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('cell', { name: 'Local para Cargo' })
